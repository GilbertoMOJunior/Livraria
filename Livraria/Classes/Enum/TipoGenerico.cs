...
public enum TipoGenerico
{
    ...
    JogosDeTabuleiroEQuebraCabecas = 9,

    [Description("Material de Papelaria e Escritório")]
    MaterialDePapelariaEEscritorio = 10,

    [Description("Produtos Relacionados à Cultura Pop")]
    ProdutosRelacionadosACulturaPop = 11,
